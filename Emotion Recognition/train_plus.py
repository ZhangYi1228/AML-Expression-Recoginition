"""
Description: Train a facial expression recognition program for FER2013 plus
"""
...
from load_and_process import  load_fer2013plus
...
log_file_path = base_path + 'lbp_plus_emotion_training.log'
...
trained_models_path = base_path + 'lbp_PLUS_mini_XCEPTION'
...
xtrain, xtest,ytrain,ytest = train_test_split(faces, emotions,test_size=0.2,random_state=20,stratify = emotions,shuffle=True)
...
model.fit_generator(data_generator.flow(xtrain, ytrain, batch_size),
                        ...
                        validation_data=(rotation_invariant_LBP(xtest),ytest))
